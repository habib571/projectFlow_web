  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Text(
        ...
        style: sataoshiMedium.copyWith(color: taskStatusModel.textColor),
      ),
    );
  }
}
    ...
    switch (statusName) {
      case "To-Do":
        return TaskStatusModel(
            statusTextColors[0], statusBackgroundColor[0], statusChipTexts[0]);
      case "In progress":
        return TaskStatusModel(
            statusTextColors[1], statusBackgroundColor[1], statusChipTexts[1]);
      default:
        return TaskStatusModel(
            statusTextColors[2], statusBackgroundColor[2], statusChipTexts[2]);
    }
  }
}

List<Color> statusTextColors = const [
  Color(0xff0087ff),
  Color(0xffff7d53),
  Color(0xff5f33e1)
];
List<Color> statusBackgroundColor = const [
  Color(0xffe3f2ff),
  Color(0xffffe9e1),
  Color(0xffede8ff)
];
