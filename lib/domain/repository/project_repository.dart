...
abstract class ProjectRepository {
  ...
  Future<Either<Failure, ProjectsResponse>> getMyProjects(PaginationRequest pagination);
  Future<Either<Failure, UsersResponse>> searchUser(PaginationRequest pagination ,String query);
  Future<Either<Failure, MemberModel>> addMember(AddMemberRequest addMemberRequest) ;
  Future<Either<Failure, List<MemberModel>>> getProjectMembers(int projectId) ;
